    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2 >Add Movie</h2>
          <ol>
            <li><a href="portfolio.html">Movies</a></li>
            <li>add Movie</li>
          </ol>
        </div>
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5">
            <div class="portfolio-info" style="padding-top: -20px; margin-top: -20px;">
              <h3>Movie information</h3>
              <ul>
                <li>Title <input id="title" name="title" class="form-control" type="text"></li>
                <li>Length <input id="length" name="length" class="form-control" type="text"></li>
                <li>Category
                    ...
                    @foreach ($catagories as $catagory)
                        <option required class="form-control" value="{{$catagory->name}}">{{$catagory->name}}</option>
                    @endforeach
                    </select>
                </li>
                <li>Producer <input id="producers" name="producers" class="form-control" type="text"></li>
                <li>Director <input id="directors" name="directors" class="form-control" type="text"></li>
                <li>Actors <input id="actors" name="actors" class="form-control" type="text"></li>
                <li>Released Year <input id="released_year" name="released_year" class="form-control" type="number"></li>
                {{-- <li>Show-time
                    <div  class="d-flex">
                        <input class="form-control" id="show_date" name="show_date" type="date" style="width: 60%;">
                        <input class="form-control" id="show_time" name="show_time" type="time" style="margin-left: 10px; width: 40%;">
                    </div>
                </li>
                <li>Ticket-Value
                    <div  class="d-flex">
                        <span style="font-weight: 600; margin-left: 5px;"> VIP: </span><input id="vip" name="vip" class="form-control" type="number" style="margin-left: 10px; width: 30%;">
                        <span style="font-weight: 600; margin-left: 40px;"> Normal: </span><input id="normal" name="normal" class="form-control" type="number" style="margin-left: 10px; width: 30%;">
                    </div>
                </li>--}}
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Movie detail</h2>
              <textarea type="textarea" id="description" name="description" class="form-control" cols="60" rows="10"></textarea>
            </div>
          </div>


          <div class="col-lg-6 add-video"  style="margin-left: 80px">
            <ul><a href="#" class="get-started-btn p-2" style="font-size: 16px"
                onclick="videoUpload()">Upload Trailer</a></ul>
                <script>
                    function videoUpload(){
                        var pagebutton= document.getElementById("videoUpload");
                        pagebutton.click();
                    }
                </script>
            <div class="container1 show-controls">
                {{-- <div class="add"><a href="#" title="Add Trailer" class="align-content-center rounded-circle add-video ri ri-add-fill"></a></div> --}}
                <div class="wrapper">
                    ...
                    <ul class="video-controls">
                        ...
                        <li class="options center" style="color: #fff;">
                        ...
                        <li class="options right">
                            <div class="playback-content">
                                ...
                                <ul class="speed-options" style="text-align: left;">
                ...
                <input type='file' accept="video/*" name="trailer" id='videoUpload' style="display: none"/>
            ...
            <div class="p-3"></div>
            <div class="portfolio-details-slider swiper" style="max-height: 500px; max-width: 310px;">
                <input type="file" id="poster" accept="image.*" style="display: none;" onclick="alert('poster')">
            <ul><a href="#" class="get-started-btn p-2" style="font-size: 16px"
                onclick="posterUpload()">Upload Posters</a></ul>
                <script>
                    function posterUpload(){
                        var pagebutton= document.getElementById("fileUpload");
                        pagebutton.click();
                    }
                </script>
            {{-- UPLOAD POSTERS --}}
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
                <div id="wrapper" style="margin-top: 20px;"><input name="posters[]" id="fileUpload" multiple="multiple" type="file" style="display: none;"/>
                ...
                $(document).ready(function() {
                        ...
                        // var image_holder = $("#swiper-wrapper");
                        // image_holder.empty();
                        var image_holder= new Array();
                        var j = 0;
                ...
                <div id="swiper-wrapper" class="swiper-wrapper align-items-center">

                  <div id="swiper-slide0" class="swiper-slide"><span style="font-size: 40px;"> Poster </span></div>

                </div>
              </div>
          </div>
          <div>
            <input type="submit" value="Add movie" class="get-btn">
          </div>
        </div>
      </div>
