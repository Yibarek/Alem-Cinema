        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5">
            <div class="portfolio-info" style="padding-top: -20px; margin-top: -20px;">
              ...
              <ul>
                <li>Title <input id="title" name="title" class="form-control" type="text" value="{{$movie->title}}"></li>
                ...
                <li>Category
                    ...
                    @foreach ($catagories as $catagory)
                        <option required class="form-control" value="{{$catagory->name}}"
                            @if ($catagory->name == $movie->catagory)
                                selected
                            @endif
                ...
                <li>Producer <input id="producers" name="producers" class="form-control" type="text" value="{{$movie->producers}}"></li>
                <li>Director <input id="directors" name="directors" class="form-control" type="text" value="{{$movie->directors}}"></li>
                <li>Actors <input id="actors" name="actors" class="form-control" type="text" value="{{$movie->actors}}"></li>
                <li>Released Year <input id="released_year" name="released_year" class="form-control" type="number" value="{{$movie->released_year}}"></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Movie detail</h2>
              <textarea type="textarea" id="description" name="description" class="form-control" cols="60" rows="10" >{{$movie->description}}</textarea>
            </div>
          </div>
          ...
          <div class="col-lg-6 add-video"  style="margin-left: 80px">
            ...
            <div class="container1 show-controls" style="width: 500px; height: 300px;">
                ...
                <video class="" src="../video/{{$movie->trailer}}" controls style="width: 100%; height: 100%;"></video>
            ...
            <div class="portfolio-details-slider swiper" style="max-height: 500px; max-width: 310px;">
                <input type="file" id="poster" style="display: none;" onclick="alert('poster')">
            <ul><a href="#" class="get-started-btn p-2" style="font-size: 16px"
            ...
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
                <div id="wrapper" style="margin-top: 20px;"><input id="fileUpload" multiple="multiple" type="file" style="display: none;"/>
                ...
                <div id="swiper-wrapper" class="swiper-wrapper align-items-center">
                  ...
                  <div id="swiper-slide0" class="swiper-slide">
          ...
          <div>
            <input type="submit" value="Edit Movie" class="get-btn">
          </div>
        </div>
      </div>
