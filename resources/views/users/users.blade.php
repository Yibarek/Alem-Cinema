        ...
        <div class="container">
          ...
          <div class="row se" data-aos="fade-in">
            <div class="col-xxl-4 col-md-4 p-1 search-box" style="margin-top: -50px; max-width: 280px;">
                <input class="ml-3 form-control" onkeypress="searchUser()" onkeyup="searchUser()" onkeydown="searchUser()" id="search_input" type="text" placeholder="Search User..." name="search movies" value="" style="border: none;">
                <button class="search-btn p-2" onclick="searchUser()" title="Search" type="submit" style="right: 0; top: 8; position: absolute;"><i class="ri ri-search-line"></i></button>
            </div>
          </div>
                ...
                ?>
                  ...
                  @if (Auth::user()->role == 'Admin')
                    <tr>
                      ...
                      <td><a href="/userProfile/{{$user->id}}" style="text-decoration: none;"> {{ $user->username }}</a></td>
                      <td >{{ $user->account }}</td>
                      <td class="hide">{{ $user->email }}</td>
                      <td class="hide">{{ $user->phone }}</td>
                      <td>{{ $user->role }}</td>
                      <td>
                  ...
                  @endforeach
                  @if ($no == 0)
                      <tr style="text-align: center;"><td class="not-found" colspan="7"><h6>No User Data</h6></td></tr>
                  @endif
              </tbody>
              <tbody class="searchData" id="searchData"></tbody>
                  <tfoot>
                      <tr>
        ...
        <div class="modal-content" style="overflow: auto; height: 90%;">
            ...
            <div class="modal-body p-3" style=" height: 80%; margin-top: 25px;">
                <div class="pl-5" style="width: 85%; margin: auto;">
                    <form onsubmit="return confirmP()" action="/addUser" method="POST" enctype="multipart/form-data">
                        @csrf
                    <table class="pl-5" style="width: 100%; margin: auto;">
                        <tr style="margin-bottom: -40px">
                            <td></td>
                            <td><a href="#" class="get-started-btn p-1" style="font-size: 16px"
                                onclick="addProfile()">Upload Profile</a></td>
                                <script>

                                    function addProfile(){
                                        var pagebutton= document.getElementById("profile");
                                        pagebutton.click();
                                    }
                                </script>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 8px;">
                                <div id="profile_picture" style="width: 150px; height: 150px;" class='rounded-circle'>
                                    <img src="../image/userProfile/profile.png" alt="" style="width: 100%; height: 100%;">
                                </div>
                            </td>
                        </tr>
                            ...
                            function handleFileSelect(e) {
                              ...
                              filesArr.forEach(function (f) {
                                ...
                                reader.onload = function (e) {
                                  ...
                                  var html =
                                    '<input type="image" id="image" name="image" src="' +
                                    e.target.result +
                                    "\" data-file='" +
                                    f.name +
                        ...
                        <tr style="width: 100%; margin: auto;">
                            <div>
                                ...
                                <td class="p-2" style="width: 65%;" >
                                    <input required class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)" type="text" name ="username" id ="username">
                                </td>
                            </div>
                        </tr>
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <select name="role" id="role" style=" color: #333; width: 100%; height: 40px; border: 1px solid #e1e1e1;">
                                        <option value="Multimedia Specialist" style="color: #333;">Multimedia Specialist</option>
                                        <option value="Ticket Controller" >Ticket Controller</option>
                                    </select>
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control" maxlength="13" min="10" onkeypress="return (event.charCode >= 48 && event.charCode <= 59)" type="text" name ="phone" id ="phone" value="+251">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control"  type="password" name ="repassword" id ="repassword">
                                </td>

                            </div>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: center;"><input type="submit" style="border: rgb(27, 134, 167);" value="Add" class="get-btn"></td>
                        </tr>
...
@foreach ($users as $user)
<div style="height: 100%; width: 100%; margin: auto; display: none;"
    class="modal fade" id="viewuser{{$user->id}}" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="min-width: 50%;">
        <div class="modal-content" style="overflow: auto; height: 100%;">
            ...
            <?php $i=1; ?>
            <div class="modal-body p-3 first" style=" height: 80%; margin-top: 25px;">
                ...
                <table class="pl-5" style="width: 85%; margin: auto;">
                    <tbody>
                        <tr>
                            <td></td>
                            <td><a href="#" class="get-started-btn p-2" style="font-size: 16px"
                                    onclick="profileEdit()">Upload Profile</a></td>
                            <script>

                                function profileEdit(){
                                    var pagebutton1= document.getElementById("profile1");
                                    pagebutton1.click();
                                }
                            </script>
                    </tr>
                  <tr class=" p-2" style=" height: 1px;">
                        <td>
                            <label>Profile</label>
                        </td>
                        <td style="margin-top: -40px">
                            <input type="file" name ="profile1" id ="profile1" style="display: none;" >
                        </td>
                    </tr>
                    ...
                    <tr class="" style="display: none;">
                        <div style="display: none;">
                            ...
                            <td class="p-2">
                                <input type="text" name ="pi1" id ="pi1" value="{{$user->profile}}">
                            </td>
                    ...
                    <tr class="" style="height: 1px;">
                        ...
                        <td style="padding-top: 10px; padding-bottom: 10px; margin: auto;">
                            <div id="profile_picture1" style="width: 150px; height: 150px;" class='rounded-circle'>
                                <img src="../image/userProfile/{{$user->profile}}" alt="" style="width: 100%; height: 100%;">
                            </div>
                        </td>
                    </tr>
                    ...
                    <script>
                        ...
                        var storedFiles2 = [];
                        $(document).ready(function () {
                            $("#profile1").on("change", handleFileSelect2);
                            selDiv2 = $("#profile_picture1");
                        });

                        function handleFileSelect1(e2) {
                            ...
                            storedFiles2.push(f2);

                            var reader2 = new FileReader();
                            reader2.onload = function (e2) {
                                document.getElementById("pi1").value = f2.name;
                                var html2 =
                                '<input type="image" id="image1" src="' +
                                e2.target.result +
                                "\" data-file='" +
                                f2.name +
                                "alt='Category Image' height='200%' width='200%' '>";
                                selDiv2.html(html2); alert(html2);
                            };
                        ...
                        <tr style="width: 100%; margin: auto;">
                            <div>
                                ...
                                <td class="p-2" style="width: 65%;" >
                                    <input required class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)" type="text" name ="username" id ="username" value="{{$user->username}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <select class="selectVal" name="role" id="role" style=" color: #333; width: 100%; height: 40px; border: 1px solid #e1e1e1;" @if ($user->role == 'admin') disabled @endif>
                                        <option value="Multimedia Specialist" style="color: #333;" @if ($user->role == 'Multimedia Specialist') selected @endif>Multimedia Specialist</option>
                                        <option value="Ticket Controller" @if ($user->role == 'Ticket Controller') selected @endif >Ticket Controller</option>
                                    </select>
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input disabled class="form-control"  type="text" name ="account" id ="account" placeholder="" value="{{$user->account}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control" maxlength="13" min="10" onkeypress="return (event.charCode >= 48 && event.charCode <= 59)" type="text" name ="phone" id ="phone" value="{{$user->phone}}">
                                </td>

                            </div>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: center;"><input type="submit" style="border: rgb(27, 134, 167);" value="Edit" class="get-btn"></td>
                        </tr>
                    </tbody>
...
<script>
    ...
    function confirmP(){
        ...
        var repassword = document.getElementById('repassword').innerHTML;
        if(password == repassword){
            return true;
        }
        else{
            p.innerHTML = "Password macth Error!";
            return false;
        }
    }
