...
<main id="main" style="width: 100%; margin: auto; margin-top: 30px;">
    ...
    <section id="portfolio" class="portfolio">
        <div class="container" style="margin-top: -50px; height: 500px;">
          ...
          <div class="row portfolio-container" data-aos="fade-up" style="margin-top: 0;" >
                  ...
                  <div class="col-xl-4">
                    ...
                    <div class="card">
                      <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        <img src="../../image/userProfile/{{Auth::user()->profile}}" alt="Profile" class="rounded-circle" style="width: 150px; height: 150px;">
                      ...
                      <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                          ...
                          <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                            ...
                            <form action="/editProfile" method="POST" >
                              ...
                              <div class="row mb-3">
                                ...
                                <div id="" class="col-md-8 col-lg-9">
                                  <div id="profile_picture"><img src="../image/userProfile/{{Auth::user()->profile}}" alt="Profile" style="width: 150px; height: 150px;"></div>
                                  <div class="pt-2">
                                    <a href="#" class="btn btn-primary btn-sm" title="Upload new profile image" onclick="profileUpload()"><i class="bi bi-upload"></i></a>
                            ...
                            <tr  style="margin-top: -40px display: none;">
                                <div>
                                    <td class="">
                            ...
                            <tr style="display: none;">
                                <div>
                                    <td class="p-2">
                                        <label style="display: none;">Image1</label>
                                    </td>
                                    <td class="p-2">
                                        <input type="text" name ="pi" id ="pi" value="{{Auth::user()->profile}}" style="display: none;">
                                    </td>
                                </div>
                            </tr>
                            {{-- <tr>
                                  ...
                                  filesArr.forEach(function (f) {
                                    ...
                                    reader.onload = function (e) {
                                      ...
                                      var html =
                                        ...
                                        "\" data-file='" +
                                        f.name +
                                        "alt='Category Image' height='150' width='150' class='rounded-circle'>";
                                      selDiv.html(html);
                                    };
                          ...
                          <div class="tab-pane fade pt-3" id="profile-change-password">
                            ...
                            <form onsubmit="return confirm()" action="/changePassword" id="change_password-form" method="POST">
                                @csrf
                            <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                        <label for="renewPassword" class="col-md-8 col-lg-5 col-form-label">Confirm Password</label>
                        <div class="col-md-8 col-lg-6">
                        ...
                        <div class="text-center">
                        <input type="submit" class="btn btn-primary p-2" value="Change Password">
                        </div>
                    </form>
