...
<div class="pages p-2">
  ...
  <div class="row" style="width: 100%; max-width: 700px;; margin: auto;">
    ...
    <form action="/report">
        <div class="container d-flex p-2 page-header" style=" margin-bottom:50px; margin-left: -43%; width: 100%; min-width: 900px; height: 40px;">
            <label class="" style="width: 100%; text-align: center;  font-size: 17px;"><strong>{{--$report--}}</strong></label>
            <label class="" style="width: 90%; margin-right: -60px; text-align: center;  font-size: 17px;">FirstDate : </label>
            <input class="form-control" type="date" id="first_date" name="first_date">
            <label class="" style="width: 100%; margin-right: -60px; text-align: center;  font-size: 17px;">LastDate : {{--$to--}}</label>
            <input type="date" class="form-control" style="width: 90%;" id="last_date" name="last_date">
        </div>
        <input type="submit" class="form-control get-started-btn" style="width: 40%; margin-top:30px; margin: auto;" value="Featch">
    </form>
  </div>
