...
<div class="pages p-2">
  ...
  <div class="row" style="width: 100%; max-width: 700px;; margin: auto;">
    ...
    <form action="/report">
        <div class="container d-flex p-2 page-header" style=" margin-bottom:50px; margin-left: -43%; width: 100%; min-width: 900px;">
            ...
            <label class="" style="width: 100%; margin-right: -60px; margin-top: 50px; text-align: center;  font-size: 17px;">To : {{--$to--}}</label>
